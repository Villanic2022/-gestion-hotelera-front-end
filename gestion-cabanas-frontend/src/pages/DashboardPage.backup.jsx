...
export default function DashboardPage() {
    ...
    async function handleCheckDisponibilidadHotel() {
        ...
        try {
            ...
            setHotelDispData(data);
            showToast("success", "Disponibilidad del hotel obtenida");
        } catch (err) {
    ...
    async function cargarCalendarioDisponibilidad() {
        ...
        try {
            ...
            if (habitacionId) {
                ...
                // Generar fechas ocupadas para esta habitación
                            ...
                            <div className="crud-modal-body">
                                ...
                                {calendarioData && modoCalendario && (
                                    <div>
                                        ...
                                        {/* Leyenda */}
                                        <div style={{ display: "flex", gap: "20px", marginBottom: "15px", fontSize: "12px", justifyContent: "center" }}>
